...
<template slot-scope="scope">
  <p>
    ...
    <el-button type="text" size="mini" @click="beBlank(scope.row)" v-if="!scope.row.isInBlacklist">拉黑</el-button>
    <el-button type="text" size="mini" @click="notBlank(scope.row)" v-if="scope.row.isInBlacklist">取消拉黑</el-button>
